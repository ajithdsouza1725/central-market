...
const floorsData = [
  ...
  },
  {
    ...
    levels: [
      { name: "Anchor Shops", shops: 3, kiosks: 0, area: "3800–4500 sft", details: "3 large Anchor Shops for flagship brands or department stores. Premium corner positions with maximum frontage and visibility." },
      { name: "Mini Anchor", shops: 1, kiosks: 0, area: "~2800 sft", details: "1 Mini Anchor space — ideal for mid-size retail brands, electronics showrooms or specialty stores." },
      { name: "Retail Shops & Kiosks", shops: 32, kiosks: 2, area: "280–450 sft", details: "32 retail shops in varying sizes across the floor. 2 kiosks for smaller businesses. Parking area integrated on this level (~100.50 M section)." },
    ],
    keyFeatures: [
      "3 Anchor Shops for flagship brands",
      "1 Mini Anchor for mid-size retail",
      "32+ retail shops with wide corridors",
  ...
  },
  {
    ...
    planImage: "/images/floor-plan-1st-2nd.png",
    levels: [
      { name: "Anchor Shops", shops: 3, kiosks: 0, area: "3800–4500 sft", details: "3 large Anchor Shops — same premium format as 1st Floor. Ideal for fashion, lifestyle, and department store brands." },
      { name: "Mini Anchor", shops: 1, kiosks: 0, area: "~2800 sft", details: "1 Mini Anchor space for mid-size retail brands." },
      { name: "Retail Shops", shops: 27, kiosks: 0, area: "300–450 sft", details: "27 retail shops. Integrated parking area (~102.00 M section). Connected to 1st and 3rd floors via lifts and escalators." },
    ],
    keyFeatures: [
      "3 Anchor Shops + 1 Mini Anchor",
      "27 retail shops",
      "Integrated parking area (102.00 M)",
  ...
  },
  {
    ...
    levels: [
      { name: "Food Court & Stalls", shops: 0, kiosks: 2, area: "~5500 sft + stalls", details: "Large food court area with 8 food stalls (FC-1 to FC-8). Includes dish wash, pot wash, and dedicated kitchen areas. 300+ seating capacity." },
      { name: "Fun Center", shops: 0, kiosks: 0, area: "~4000 sft", details: "Dedicated entertainment and fun zone — gaming arcades, play areas, or family entertainment center." },
      { name: "Home Furniture", shops: 0, kiosks: 0, area: "~5000 sft", details: "Large format home furniture showroom space on the lower section of the floor." },
      { name: "Restaurants & Cafe", shops: 2, kiosks: 0, area: "1200–2500 sft", details: "Restaurant-1 and Restaurant-2 on the right wing. Dedicated Cafe space. Premium F&B destinations." },
      { name: "Retail Shops", shops: 18, kiosks: 0, area: "300–380 sft", details: "18 retail shops spread across the central zone of the floor." },
    ],
    keyFeatures: [
      "Food Court with 8 stalls (FC-1 to FC-8) & 300+ seating",
      "Fun Center — entertainment & gaming zone",
      "Home Furniture showroom (~5000 sft)",
      "2 full restaurants + 1 cafe",
      "18 retail shops + 2 kiosks",
      "Dish wash, pot wash & kitchen infrastructure",
    ],
  },
  {
    id: "4f",
